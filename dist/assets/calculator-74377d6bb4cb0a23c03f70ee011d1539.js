...
return Object.defineProperty(a,"__esModule",{value:!0}),a}catch(n){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("calculator/app").default.create({name:"calculator",version:"0.0.0+7afed6b7"})
