...
export declare namespace Statements {
    ...
    type OpenElement = [Opcodes.OpenElement, str, boolean];
    ...
    type ComponentAttr = [Opcodes.ComponentAttr, str, Expression, Option<str>];
    ...
    type TrustingComponentAttr = [Opcodes.TrustingComponentAttr, str, Expression, str];
    ...
    type Statement = Text | Append | Comment | Modifier | Block | Component | DynamicComponent | OpenElement | FlushElement | CloseElement | StaticAttr | DynamicAttr | ComponentAttr | AttrSplat | Yield | Partial | StaticArg | DynamicArg | TrustingAttr | TrustingComponentAttr | Debugger | ClientSide;
    type Attribute = Statements.StaticAttr | Statements.DynamicAttr | Statements.ComponentAttr | Statements.TrustingAttr | Statements.TrustingComponentAttr | Statements.AttrSplat;
