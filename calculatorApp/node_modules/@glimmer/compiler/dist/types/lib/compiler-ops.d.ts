...
export declare type OpName = keyof CompilerOps<Opaque>;
export declare type Processor<InOps extends CompilerOps<Opaque>, OutVariable, OutOps extends CompilerOps<OutVariable>> = {
